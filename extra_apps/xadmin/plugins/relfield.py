...
class ForeignKeySearchWidget(forms.Widget):
    ...
    def build_attrs(self, attrs={}, extra_attrs=None, **kwargs):
        to_opts = self.remote_field.to._meta
        ...
        if self.remote_field.limit_choices_to:
            for i in list(self.remote_field.limit_choices_to):
                attrs['data-choices'] += "&_p_%s=%s" % (i, self.remote_field.limit_choices_to[i])
    ...
    def label_for_value(self, value):
        ...
        try:
            obj = self.remote_field.to._default_manager.using(
...
class ForeignKeySelectWidget(ForeignKeySearchWidget):
    ...
    def build_attrs(self, attrs={}, **kwargs):
        ...
        attrs['data-placeholder'] = _('Select %s') % self.remote_field.to._meta.verbose_name
        return attrs
